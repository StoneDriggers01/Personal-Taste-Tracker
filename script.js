...
let favoriteFoods = ["Spaghettios", "Pizza", "Tacos", "Burgers", "Boiled Peanuts", "Beef Roast"];
...
printFoodRecommendation("Boiled Peanuts");
printFoodRecommendation("Beef Roast");
